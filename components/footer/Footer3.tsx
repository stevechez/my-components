    ...
    <>
      <section className="px-6 py-6 text-gray-600 bg-gray-50 lg:px-8 md:py-12">
        <div className="py-6 mx-auto mb-12 space-y-6 border-b-2 border-gray-200 max-w-7xl lg:mb-16 md:py-12 lg:pb-20 md:flex md:justify-between md:items-center md:flex-row md:space-x-12 ">
          <div className="flex-1 max-w-3xl ">
            <h4 className="text-2xl font-medium text-gray-700 sm:text-3xl md:text-4xl">
              Start Building the App of Your Dreams
            </h4>
            <p className="mt-4 text-base font-medium leading-relaxed text-gray-500 md:text-xl">
              Are you ready to start crafting the money-generating application
              you've always dreamed. There's never been a better time to get
              started.
            </p>
          </div>
          <a
        ...
        <div className="flex flex-col items-center justify-between max-w-screen-xl mx-auto mt-16 md:flex-row lg:mt-20">
          ...
          <div className="text-sm">© 2021 Tails. All Rights Reserved.</div>
        </div>
      </section>
    </>
  )
