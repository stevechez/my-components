...
const Footer6: NextPage = () => {
  return (
    <>
      <footer className="pb-6 pt-16 bg-white">
        ...
        <ul className="text-sm font-medium pb-10  sm:pb-20 grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-y-10">
            ...
            <li className="space-y-5 row-span-2">
                ...
                <ul className="space-y-2 sm:space-y-4">
                    ...
                    <li><a className="hover:text-gray-900 transition-colors duration-200 text-xl sm:text-2xl" href="/">Status</a></li>
            ...
            <li className="space-y-5">
                ...
                <ul className="space-y-2 sm:space-y-4">
                    <li><a className="hover:text-gray-900 transition-colors duration-200 text-xl sm:text-2xl" href="/">Twitter</a></li>
                    <li><a className="hover:text-gray-900 transition-colors duration-200 text-xl sm:text-2xl" href="/">Facebook</a></li>
                    <li><a className="hover:text-gray-900 transition-colors duration-200 text-xl sm:text-2xl" href="/">Instagram</a></li>
                </ul>
            </li>
        </ul>
