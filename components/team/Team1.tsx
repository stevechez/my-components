        ...
        <div className="pt-16 pb-16 pl-4 pr-4 mx-auto ml-auto mr-auto bg-top bg-cover max-w-7xl md:px-24 lg:px-12 lg:py-20">
          <div className="mb-10 ml-auto mr-auto bg-top bg-cover max-w-7xl md:mx-auto sm:text-center lg:max-w-2xl md:mb-16">
            ...
            <p className="text-base text-gray-700 md:text-lg">
              We love the work we do and we love the amazing people we work
              with. Check out our awesome team of individuals below.
            </p>
          </div>
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <div className="relative overflow-hidden rounded-md shadow-lg group">
                <img
                  ...
                  src="https://cdn.devdojo.com/images/july2021/team-member-1.jpg"
            ...
            <div>
              <div className="relative overflow-hidden rounded-md shadow-lg group">
                <img
                  className="object-cover w-full h-72 xl:h-80"
                  src="https://cdn.devdojo.com/images/july2021/team-member-2.jpg"
                  alt="Team Member Name"
                />
                <div className="absolute inset-0 px-6 py-4 text-center duration-300 opacity-0 group-hover:opacity-100">
                  <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-500 opacity-60 to-purple-600"></div>
            ...
            <div>
              <div className="relative overflow-hidden rounded-md shadow-lg group">
                <img
                  className="object-cover w-full h-72 xl:h-80"
                  src="https://cdn.devdojo.com/images/july2021/team-member-3.jpg"
                  alt="Team Member Name"
                />
                <div className="absolute inset-0 px-6 py-4 text-center duration-300 opacity-0 group-hover:opacity-100">
                  <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-500 opacity-60 to-purple-600"></div>
            ...
            <div>
              <div className="relative overflow-hidden rounded-md shadow-lg group">
                <img
                  className="object-cover w-full h-72 xl:h-80"
                  src="https://cdn.devdojo.com/images/july2021/team-member-4.jpg"
                  alt="Team Member Name"
                />
                <div className="absolute inset-0 px-6 py-4 text-center duration-300 opacity-0 group-hover:opacity-100">
                  <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-500 opacity-60 to-purple-600"></div>
                  <div className="relative flex flex-col items-center justify-center w-full h-full">
                    ...
                    <p className="mb-4 text-xs tracking-wide text-blue-50">
                      Jeremy loves to spend time with his family and go to the
                      gym.
                    </p>
                    <div className="flex items-center justify-center space-x-3 bg-top bg-cover">
                      <div className="transition-colors duration-300 bg-top bg-cover cursor-pointer hover:text-white text-blue-50">
            ...
            <div>
              <div className="relative overflow-hidden rounded-md shadow-lg group">
                <img
                  className="object-cover w-full h-72 xl:h-80"
                  src="https://cdn.devdojo.com/images/july2021/team-member-5.jpg"
                  alt="Team Member Name"
                />
                <div className="absolute inset-0 px-6 py-4 text-center duration-300 opacity-0 group-hover:opacity-100">
                  <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-500 opacity-60 to-purple-600"></div>
            ...
            <div>
              <div className="relative overflow-hidden rounded-md shadow-lg group">
                <img
                  className="object-cover w-full h-72 xl:h-80"
                  src="https://cdn.devdojo.com/images/july2021/team-member-6.jpg"
                  alt="Team Member Name"
                />
                <div className="absolute inset-0 px-6 py-4 text-center duration-300 opacity-0 group-hover:opacity-100">
                  <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-500 opacity-60 to-purple-600"></div>
            ...
            <div>
              <div className="relative overflow-hidden rounded-md shadow-lg group">
                <img
                  className="object-cover w-full h-72 xl:h-80"
                  src="https://cdn.devdojo.com/images/july2021/team-member-7.jpg"
                  alt="Team Member Name"
                />
                <div className="absolute inset-0 px-6 py-4 text-center duration-300 opacity-0 group-hover:opacity-100">
                  <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-500 opacity-60 to-purple-600"></div>
            ...
            <div>
              <div className="relative overflow-hidden rounded-md shadow-lg group">
                <img
                  className="object-cover w-full h-72 xl:h-80"
                  src="https://cdn.devdojo.com/images/july2021/team-member-8.jpg"
                  alt="Team Member Name"
                />
                <div className="absolute inset-0 px-6 py-4 text-center duration-300 opacity-0 group-hover:opacity-100">
                  <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-500 opacity-60 to-purple-600"></div>
