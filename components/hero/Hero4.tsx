            ...
            <div className="flex items-center w-full lg:w-1/2 lg:pr-10">
                <div className="relative max-w-lg mx-auto font-sans text-center text-gray-700 border-gray-200 lg:text-left">
                    ...
                    <div className="relative flex items-start justify-start block w-full max-w-md text-center lg:mx-0">
                        <a href="#_" className="flex items-center justify-center px-8 font-medium text-white bg-blue-500 rounded-full h-14">Get Started Today</a>
            ...
            <div className="relative w-full mt-20 lg:w-1/2 lg:mt-0">
                <div className="relative z-20 grid w-full grid-cols-4 gap-5 mt-4 transform -rotate-6">
                    <div className="flex items-center justify-center w-full h-auto col-span-2 p-3 overflow-hidden transform bg-white rounded-lg shadow-xl -rotate-3">
                        <Image src="https://cdn.devdojo.com/images/january2021/image1.png" className="w-full h-auto" />
                    </div>
                    <div className="flex items-center justify-center w-full h-auto col-span-2 p-3 overflow-hidden transform bg-white rounded-lg shadow-xl -rotate-3">
                        <Image src="https://cdn.devdojo.com/images/january2021/image2.png" className="w-full h-auto" />
                    </div>
                    <div className="flex items-center justify-center w-full h-auto col-span-2 p-3 overflow-hidden transform bg-white rounded-lg shadow-xl -rotate-3">
                        <Image src="https://cdn.devdojo.com/images/january2021/image3.png" className="w-full h-auto" />
                    </div>
                    <div className="flex items-center justify-center w-full h-auto col-span-2 p-3 overflow-hidden transform bg-white rounded-lg shadow-xl -rotate-3">
                        <Image src="https://cdn.devdojo.com/images/january2021/image4.png" className="w-full h-auto" />
                    </div>
                    <div className="flex items-center justify-center w-full h-auto col-span-2 p-3 overflow-hidden transform bg-white rounded-lg shadow-xl -rotate-3">
                        <Image src="https://cdn.devdojo.com/images/january2021/image5.png" className="w-full h-auto" />
                    </div>
                    <div className="flex items-center justify-center w-full h-auto col-span-2 p-3 overflow-hidden transform bg-white rounded-lg shadow-xl -rotate-3">
                        <Image src="https://cdn.devdojo.com/images/january2021/image6.png" className="w-full h-auto" />
                    </div>
                </div>


                <div className="absolute top-0 right-0 z-10 w-full h-full mt-4 -mr-5 transform scale-125 rotate-45">
                    <svg className="absolute top-0 w-full h-full transform opacity-50 fill-current lg:scale-x-150 text-blue-50" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
