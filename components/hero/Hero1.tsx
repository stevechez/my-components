...
const Hero1: NextPage = () => {
  return (
    <>
      <section className="relative px-2 py-12 bg-white sm:py-20 md:py-32 md:px-0">
          ...
          <div className="relative z-20 h-full px-8 mx-auto max-w-7xl xl:px-5">
            <div className="flex flex-wrap items-center h-full sm:-mx-3">
              <div className="w-full pl-10 pr-10 sm:pl-0 md:w-1/2 xl:pr-3">
                <div className="w-full pb-6 pl-0 space-y-4 sm:pl-10 md:max-w-md lg:max-w-lg md:space-y-5 lg:space-y-6 xl:space-y-7 sm:pr-5 lg:pr-0 md:pb-0">
                  <p className="font-medium tracking-wide text-blue-600 uppercase">
                  ...
                  <p className="mx-auto text-base text-gray-500 lg:leading-9 md:max-w-md lg:text-xl md:max-w-3xl">
                    You built an amazing application, why not give it some love
                    with a pretty looking landing page.
                  </p>
                  <div className="relative flex flex-col space-y-3 lg:flex-row lg:space-y-0 lg:space-x-4 md:pr-10 lg:pr-0">
                    <a
                      href="#_"
        ...
        <div className="relative top-0 left-0 z-10 flex items-center w-full h-full py-12">
          ...
          <div className="w-full -mr-32 2xl:-mr-64 md:w-7/12">
            <img
              ...
              className="w-full transform scale-110 md:scale-150"
            />
          </div>
        </div>
      </section>
